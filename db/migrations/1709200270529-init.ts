...
export class Init1709200270529 implements MigrationInterface {
  name = 'Init1709200270529';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "invoice" ("nr" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1337 INCREMENT BY 1), "isStorno" boolean NOT NULL, "currency" character varying NOT NULL, "amount" character varying NOT NULL, "date" TIMESTAMP NOT NULL, "customerId" integer, CONSTRAINT "PK_0f51ac26eb306cdd5589e833e61" PRIMARY KEY ("nr"))`,
    );
    await queryRunner.query(
